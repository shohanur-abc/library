...
import { ArrowRight, Code2, Layers, Play, Rocket, Sparkles } from 'lucide-react'
                    ...
                    {featureCards.map((card) => {
                        return (
                            <Link href={card.link} key={card.title}>
                                <Card className="group relative overflow-hidden border-2 hover:border-primary/50 hover:shadow-xl transition-all duration-300">
                                    ...
                                    <CardHeader className="pb-2">
                                        <div className="flex items-center justify-between">
                                            <div className="w-12 h-12 rounded-xl flex items-center justify-center shadow-lg">
                                                <Image src={card.icon} alt={card.title} width={40} height={40} className="object-contain rounded-md" />
                                            </div>
